package com.nttdata.proyecto1bc43.config;
...
public class SwaggerConfig {
   ...
   public static final Contact DEFAULT_CONTACT = new Contact("William Borda", "https://www.nttdata.com",
    ...
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Proyecto2BC43 Api Documentation", "Proyecto2BC43 Api Documentation", "1.0",
